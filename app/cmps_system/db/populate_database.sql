...
VALUES
    ...
    (
        'Performance Review',
        'Evaluation of instructor performance with a score metric',
        FALSE,
        TRUE,
        FALSE
    );
    ...
    (
        (
            ...
            FROM
                evaluation_type
            WHERE
                evaluation_type_name = 'Performance Review'
        ),
        1,
        'Score',
        0,
...
VALUES
    ...
    (1, 1, NULL, 1, NULL, '2024-07-05', 90),
    (1, 2, NULL, 1, NULL, '2024-07-05', 95),
    (2, 1, 2, NULL, NULL, '2024-07-10', 85),
    (2, 2, 2, NULL, NULL, '2024-07-10', 87),
    (3, 1, 3, 2, NULL, '2024-07-15', 4),
    (3, 2, 3, 2, NULL, '2024-07-15', 4),
    (3, 3, 3, 2, NULL, '2024-07-15', 5),
    (4, 1, NULL, 3, NULL, '2024-07-20', 70),
    (4, 2, NULL, 3, NULL, '2024-07-20', 75),
    (6, 1, NULL, 4, 1, '2024-07-25', 80),
    (6, 2, NULL, 4, 1, '2024-07-25', 85),
    (5, 1, NULL, 5, NULL, '2024-08-01', 78),
    (5, 1, NULL, 5, 2, '2024-08-02', 80),
    (1, 1, NULL, 6, NULL, '2024-08-05', 88),
    (1, 2, NULL, 6, NULL, '2024-08-05', 90),
    (2, 1, 4, NULL, NULL, '2024-08-10', 82),
    (2, 2, 4, NULL, NULL, '2024-08-10', 85),
    (3, 1, 5, 7, NULL, '2024-08-15', 4),
    (3, 2, 5, 7, NULL, '2024-08-15', 5),
    (3, 3, 5, 7, NULL, '2024-08-15', 4),
    (4, 1, NULL, 8, NULL, '2024-08-20', 72),
    (4, 2, NULL, 8, NULL, '2024-08-20', 78),
    (6, 1, NULL, 9, 3, '2024-08-25', 88),
    (6, 2, NULL, 9, 3, '2024-08-25', 90),
    (5, 1, NULL, 10, NULL, '2024-08-27', 83),
    (5, 1, NULL, 10, 4, '2024-08-28', 85),
    (7, 1, NULL, 1, NULL, '2024-07-01', 88),
    (7, 1, NULL, 2, NULL, '2024-07-02', 75),
    (7, 1, NULL, 3, NULL, '2024-07-03', 80),
    (7, 1, NULL, 4, NULL, '2024-07-04', 90),
    (7, 1, NULL, 5, NULL, '2024-07-05', 85),
    (7, 1, NULL, 6, NULL, '2024-07-06', 70),
    (7, 1, NULL, 7, NULL, '2024-07-07', 60),
    (7, 1, NULL, 8, NULL, '2024-07-08', 92),
    (7, 1, NULL, 9, NULL, '2024-07-09', 78),
    (7, 1, NULL, 10, NULL, '2024-07-10', 81),
    (7, 1, NULL, 11, NULL, '2024-07-11', 88),
    (7, 1, NULL, 12, NULL, '2024-07-12', 76),
    (7, 1, NULL, 13, NULL, '2024-07-13', 83),
    (7, 1, NULL, 14, NULL, '2024-07-14', 77),
    (7, 1, NULL, 15, NULL, '2024-07-15', 85),
    (7, 1, NULL, 16, NULL, '2024-07-16', 90),
    (7, 1, NULL, 1, NULL, '2024-07-17', 82),
    (7, 1, NULL, 2, NULL, '2024-07-18', 79),
    (7, 1, NULL, 3, NULL, '2024-07-19', 75),
    (7, 1, NULL, 4, NULL, '2024-07-20', 88),
    (7, 1, NULL, 5, NULL, '2024-07-21', 84),
    (7, 1, NULL, 6, NULL, '2024-07-22', 73),
    (7, 1, NULL, 7, NULL, '2024-07-23', 69),
    (7, 1, NULL, 8, NULL, '2024-07-24', 91),
    (7, 1, NULL, 9, NULL, '2024-07-25', 79),
    (7, 1, NULL, 10, NULL, '2024-07-26', 83),
    (7, 1, NULL, 11, NULL, '2024-07-27', 90),
    (7, 1, NULL, 12, NULL, '2024-07-28', 75),
    (7, 1, NULL, 13, NULL, '2024-07-29', 87),
    (7, 1, NULL, 14, NULL, '2024-07-30', 80),
    (7, 1, NULL, 15, NULL, '2024-07-31', 82),
    (7, 1, NULL, 16, NULL, '2024-08-01', 85),
    (7, 1, NULL, 1, NULL, '2024-08-02', 77),
    (7, 1, NULL, 2, NULL, '2024-08-03', 88),
    (7, 1, NULL, 3, NULL, '2024-08-04', 91),
    (7, 1, NULL, 4, NULL, '2024-08-05', 79),
    (7, 1, NULL, 5, NULL, '2024-08-06', 82),
    (7, 1, NULL, 6, NULL, '2024-08-07', 75),
    (7, 1, NULL, 7, NULL, '2024-08-08', 69),
    (7, 1, NULL, 8, NULL, '2024-08-09', 87),
    (7, 1, NULL, 9, NULL, '2024-08-10', 81),
    (7, 1, NULL, 10, NULL, '2024-08-11', 90),
    (7, 1, NULL, 11, NULL, '2024-08-12', 78),
    (7, 1, NULL, 12, NULL, '2024-08-13', 84),
    (7, 1, NULL, 13, NULL, '2024-08-14', 80),
    (7, 1, NULL, 14, NULL, '2024-08-15', 82),
    (7, 1, NULL, 15, NULL, '2024-08-16', 88),
    (7, 1, NULL, 16, NULL, '2024-08-17', 76),
    (7, 1, NULL, 1, NULL, '2024-08-18', 85),
    (7, 1, NULL, 2, NULL, '2024-08-19', 83),
    (7, 1, NULL, 3, NULL, '2024-08-20', 79),
    (7, 1, NULL, 4, NULL, '2024-08-21', 82),
    (7, 1, NULL, 5, NULL, '2024-08-22', 75),
    (7, 1, NULL, 6, NULL, '2024-08-23', 90),
    (7, 1, NULL, 7, NULL, '2024-08-24', 87),
    (7, 1, NULL, 8, NULL, '2024-08-25', 83),
    (7, 1, NULL, 9, NULL, '2024-08-26', 88),
    (7, 1, NULL, 10, NULL, '2024-08-27', 80),
    (7, 1, NULL, 11, NULL, '2024-08-28', 82),
    (7, 1, NULL, 12, NULL, '2024-08-29', 84),
    (7, 1, NULL, 13, NULL, '2024-08-30', 78),
    (7, 1, NULL, 14, NULL, '2024-08-31', 87);
