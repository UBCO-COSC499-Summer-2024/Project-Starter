...
create table
  ...
  create or replace view v_ta_review as select ta_review.id,
CONCAT(reviewer_inst.last_name, ', ', reviewer_inst.first_name) AS reviewer,
CONCAT(reviewee_inst.last_name, ', ', reviewee_inst.first_name) AS reviewee,
