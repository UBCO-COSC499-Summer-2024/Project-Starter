...
ALTER TABLE
    "evaluation_entry" ADD PRIMARY KEY("evaluation_entry_id");
...
ALTER TABLE
    "service_role" ADD PRIMARY KEY("service_role_id");
CREATE TABLE "course"(
    ...
    CHECK
        ("mode_of_delivery" IN('online', 'in person', 'hybrid', 'field course', 'co-op')) NULL,
...
CREATE TABLE "evaluation_metric"(
    "evaluation_type_id" INTEGER NOT NULL,
    "metric_num" SERIAL NOT NULL,
    "metric_description" TEXT NOT NULL
);
ALTER TABLE
    "evaluation_metric" ADD PRIMARY KEY("evaluation_type_id", "metric_num");
CREATE TABLE "course_assign"(
    "assignment_id" SERIAL NOT NULL,
    "instructor_id" INTEGER NOT NULL,
    "course_id" INTEGER NOT NULL,
    "position" VARCHAR(255) CHECK
        ("position" IN('instructor', 'ta','others')) NOT NULL,
...
CREATE TABLE "service_hours_entry"(
...
ALTER TABLE
    "evaluation_type" ADD PRIMARY KEY("evaluation_type_id");
CREATE TABLE "service_hours_benchmark"(
...
ALTER TABLE
    "evaluation_entry" ADD CONSTRAINT "evaluation_entry_metric_num_foreign" FOREIGN KEY("metric_num", "evaluation_type_id") REFERENCES "evaluation_metric"("metric_num", "evaluation_type_id");
ALTER TABLE
    "evaluation_entry" ADD CONSTRAINT "evaluation_entry_course_id_foreign" FOREIGN KEY("course_id") REFERENCES "course"("course_id");
ALTER TABLE
    "service_hours_entry" ADD CONSTRAINT "service_hours_entry_instructor_id_foreign" FOREIGN KEY("instructor_id") REFERENCES "instructor"("instructor_id");
ALTER TABLE
    "evaluation_entry" ADD CONSTRAINT "evaluation_entry_instructor_id_foreign" FOREIGN KEY("instructor_id") REFERENCES "instructor"("instructor_id");
ALTER TABLE
    "service_hours_entry" ADD CONSTRAINT "service_hours_entry_service_role_id_foreign" FOREIGN KEY("service_role_id") REFERENCES "service_role"("service_role_id");
ALTER TABLE
    "service_hours_benchmark" ADD CONSTRAINT "service_hours_benchmark_instructor_id_foreign" FOREIGN KEY("instructor_id") REFERENCES "instructor"("instructor_id");
ALTER TABLE
    "course_assign" ADD CONSTRAINT "course_assign_course_id_foreign" FOREIGN KEY("course_id") REFERENCES "course"("course_id");
ALTER TABLE
    "evaluation_metric" ADD CONSTRAINT "evaluation_metric_evaluation_type_id_foreign" FOREIGN KEY("evaluation_type_id") REFERENCES "evaluation_type"("evaluation_type_id");
ALTER TABLE
    "service_role_assign" ADD CONSTRAINT "service_role_assign_instructor_id_foreign" FOREIGN KEY("instructor_id") REFERENCES "instructor"("instructor_id");
ALTER TABLE
