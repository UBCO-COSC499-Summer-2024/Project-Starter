...
VALUES (2024, 'Winter', 'Term 1', 'COSC', 499, 001, 69);
SELECT is(
    (SELECT num_students FROM course WHERE academic_year = 2024 AND session = 'Winter' AND term = 'Term 1' AND subject_code = 'COSC' AND course_num = 499 AND section_num = 001),
    69,
